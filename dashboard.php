  ...
  <main class="main" id="top">
    <div class="container" data-layout="container">
     ...
     <?php include 'include/header.php';?>
            ...
            <div class="card h-md-100 ecommerce-card-min-width">
              ...
              <section class="text-center">
                <div class="container">
                  <div class="row">
                    <div class="col">
                      <h1 style="color: #2a3468;" class="fs-2 fs-sm-4 fs-md-5">Hello Parth, Welcome to <font color="#ec465f">Finsol</font></h1>
                      <p class="lead">Things you will get right out of the box with Finsol.</p>
                    </div>
                  </div>
                  <div class="row mt-6">
                    <div class="col-lg-4">
                      <div onclick="location.href='gst.html'" type="button">
                        <div class="card card-span h-100">
                          ...
                          <div class="card-body pt-6 pb-4">
                            ...
                            <p>One of the best cloud platforms to make new GST registration, analyse taxes, manage
                    ...
                    <div class="col-lg-4 mt-6 mt-lg-0">
                      ...
                      <div class="card card-span h-100">
                        ...
                        <div class="card-body pt-6 pb-4">
                          ...
                          <p>With your purchased copy of Falcon, you will get all the uncompressed & documented SCSS and
                    ...
                    <div class="col-lg-4 mt-6 mt-lg-0">
                      ...
                      <div class="card card-span h-100">
                        ...
                        <div class="card-body pt-6 pb-4">
                          ...
                          <p>All the painful or time-consuming tasks in your development workflow such as compiling the
                  ...
                  <div class="row mt-6">
                    <div class="col-lg-4">
                      ...
                      <div class="card card-span h-100">
                        ...
                        <div class="card-body pt-6 pb-4">
                          ...
                          <p>Build your webapp with the world's most popular front-end component library along with
                    ...
                    <div class="col-lg-4 mt-6 mt-lg-0">
                      ...
                      <div class="card card-span h-100">
                        <div class="roundlogobgred card-span-img"><span style="color: #fff!important;"
      ...
      <?php include 'include/authentication_modal.php'; ?>
    </div>
  </main><!-- ===============================================-->
  <!--    End of Main Content-->
  <!-- ===============================================-->
